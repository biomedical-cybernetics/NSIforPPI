...
filename = '../table/table_auc_mroc_CHv2_PPI_top100.xlsx';
...
eval_metric = 'auc_mroc';
name_eval_metric = 'auc-mroc';
top = 100;
...
for j = 1:(length(networks))
    ...
    elseif strcmp(eval_metric, 'auc_pr')
        for i = 1:length(methods)
            load(['../network_perturbed/network_similarities/CH_L2_L3/results/' networks{j} '_linkrem10noconn_CHv2_L2_L3_linkpred_AUC_PR.mat'], [methods{i} '_auc_pr'])
