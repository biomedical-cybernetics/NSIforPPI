function run_suppl_table3(option)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MATLAB Script Documentation
% Author: Ilyes Abdelhamid, 2023
% Description: This MATLAB script generates/replicates the Suppl. Table 3.
% %
% INPUT
...
elseif option == 2
    ...
    disp('Running: Link prediction evaluation (AUC-mROC)')
    tic;
    compute_aucmroc;
    elapsed_time = toc;
    
    disp(['Elapsed time for link prediction evaluation: ', num2str(elapsed_time), ' s']);
    
    disp('Plotting Suppl. Table 3')
    create_suppl_table3;
