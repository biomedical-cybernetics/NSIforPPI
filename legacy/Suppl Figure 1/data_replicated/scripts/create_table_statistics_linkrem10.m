...
% values based on perturbed network (10% of links deleted) for various organisms.


filename = '../statistics/statistics_networks_linkrem10';
...
for i = 1:length(networks)
    load(['../statistics/results/' networks{i} '_linkrem10_statistics.mat']);
