function run_suppl_fig3(option)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MATLAB Script Documentation
% Author: Ilyes Abdelhamid, 2023
% Description: This MATLAB script generates/replicates the Suppl. Figure 3.
% %
% INPUT
...
elseif option == 2
    ...
    tic;
    disp('Running: permuatation test for AUP pvalues')
    compute_pvalues_aup_top100;
    elapsed_time = toc;
    
    disp(['Elapsed time for permutation test: ', num2str(elapsed_time), ' s']);
    
    disp('Plotting Suppl. Figure 3')
    plot_suppl_fig3;
