function [measures, X, Y] = prediction_evaluation(scores, labels)
...
[measures, X, Y] = compute_curves_measures(scores, labels, S, P, N);
measures.ndcg = compute_ndcg(scores, labels, P);
measures.mcc = compute_mcc(scores, labels, P, N);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [measures, X, Y] = compute_curves_measures(scores, labels, S, P, N)
