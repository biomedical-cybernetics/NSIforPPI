function run_suppl_table4(option)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MATLAB Script Documentation
% Author: Ilyes Abdelhamid, 2023
% Description: This MATLAB script generates/replicates the Suppl. Table 4.
% %
% INPUT
...
elseif option == 2
    ...
    disp('Running: Link prediction evaluation (AUC-PR)')
    tic;
    compute_aucpr;
    elapsed_time = toc;
