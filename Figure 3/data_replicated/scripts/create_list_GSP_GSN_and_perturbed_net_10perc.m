...
% the network by deleting 10% of the links.
...
save('../matrix/network_perturbed_10percent_GSP_GSN_Yeast.mat', 'L_net');
save('../matrix/list_pairs_10percent_GSP_GSN_Yeast.mat', 'L_pairs');
