function run_suppl_fig5(option)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
elseif option == 2
    ...
    disp('Running: Creation of list of protein pairs to predict and 5% Yeast DIP network perturbation')
    tic;
    create_list_GSP_GSN_and_perturbed_net_5perc;
    elapsed_time = toc;
    
    disp(['Elapsed time for Creating list of protein pairs and 5% Yeast DIP network perturbation: ', num2str(elapsed_time), ' s']);
    
    tic;
    disp('Running: CH-based scores')
    run_CHA_linkpred5_monopartite_Yeast_net_perturbed;
    elapsed_time = toc;
    
    disp(['Elapsed time for CH link prediction: ', num2str(elapsed_time), ' s']);
    % 800.9407 s
    
    disp('Plotting Suppl. Figure 5')
    plot_suppl_fig5;
