...
% Description: This MATLAB script plots Suppl. Figure 5 with the replicated results.
...
load('../network_similarities/CH_L2_L3/results/CHA_L3_scores_net_perturbed_5percent_GSP_GSN_Yeast_DIP.mat');
load('../matrix/list_pairs_5percent_GSP_GSN_Yeast.mat');
...
for i = 1:num_sims
    ...
    for j = 1:length(CH_methods)
        % cols of interest from col number 4.
