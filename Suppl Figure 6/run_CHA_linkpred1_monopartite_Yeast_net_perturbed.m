...
load('../matrix/network_perturbed_1percent_Yeast.mat');
...
save('../network_similarities/CH_L2_L3/results/CHA_L3_scores_net_perturbed_1percent_Yeast_DIP.mat', 'S', 'info', '-v7.3');