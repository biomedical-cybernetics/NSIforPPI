...
% based on perturbed network (50% of links deleted) for various organisms.
...
for i = 1:length(networks)
    display(networks{i});
    load(['../sparsified_matrices/' networks{i} '_linkrem50.mat'], 'matrices');

    filename = ['../statistics/results/' networks{i} '_linkrem50_statistics.mat'];
